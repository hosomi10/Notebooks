...
def annotate_objects(results, labels):
  ...
  for obj in results:
    ...
    print('label={}'.format(labels[obj['class_id']]))
...
def main():
  ...
  threshold =0.5;
  model_name = 'model/tflite/detect.tflite'
  label_name = 'model/tflite/labelmap.txt'
  ...
  # with picamera.PiCamera(
    ...
    # try:
      ...
      # for _ in camera.capture_continuous(
        ...
        # stream.seek(0)
  image = Image.open('dog_bgr.jpg').convert('RGB').resize((input_width, input_height), Image.ANTIALIAS)
